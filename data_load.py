...
class SpeakerDatasetTIMITPreprocessed(Dataset):
    ...
    def __init__(self,task, shuffle=True, utter_start=0):
    ...
    def overlapping_frames(self,utters):
        overlappingFrames = []
        i = 0
        while(i+160-1) < utters.shape[0]:
            overlappingFrames.append(utters[i:i+160])

            i = i+80
        return np.array(overlappingFrames)
    ...
    def __getitem__(self, idx):
        ...
        utters = self.overlapping_frames(utters)
